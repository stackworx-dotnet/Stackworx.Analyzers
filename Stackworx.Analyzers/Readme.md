...
### Stackworx.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Stackworx.Analyzers.Sample.csproj](../Stackworx.Analyzers.Sample/Stackworx.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Stackworx.Analyzers.Tests

...
|--------------------------------------------------------------------|-------|----------|----------|---------|
| [SW0001](./sw0001-avoid-implicit-datetime-to-datetimeoffset) | Avoid implicit DateTime → DateTimeOffset conversion | Usage | Warning | Flags implicit conversions from DateTime to DateTimeOffset, requiring explicit construction. |
